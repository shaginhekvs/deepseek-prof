class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f16[1024]", arg1_1: "f16[1024]", arg2_1: "f16[8, 128, 1024]", arg3_1: "f16[4096, 1024]", arg4_1: "f16[1024, 4096]"):
        ...
        view: "f16[1024, 1024]" = torch.ops.aten.view.default(convert_element_type_1, [1024, 1024]);  convert_element_type_1 = None
        mm: "f16[1024, 4096]" = torch.ops.aten.mm.default(view, permute);  view = permute = None
        view_1: "f16[8, 128, 4096]" = torch.ops.aten.view.default(mm, [8, 128, 4096]);  mm = None
        ...
        add_2: "f32[8, 128, 4096]" = torch.ops.aten.add.Tensor(convert_element_type_4, mul_4);  mul_4 = None
        mul_5: "f32[8, 128, 4096]" = torch.ops.aten.mul.Tensor(add_2, 0.7978845608028654);  add_2 = None
        mul_6: "f32[8, 128, 4096]" = torch.ops.aten.mul.Tensor(convert_element_type_4, 0.5);  convert_element_type_4 = None
        ...
        view_2: "f16[1024, 4096]" = torch.ops.aten.view.default(convert_element_type_5, [1024, 4096]);  convert_element_type_5 = None
        mm_1: "f16[1024, 1024]" = torch.ops.aten.mm.default(view_2, permute_1);  view_2 = permute_1 = None
        view_3: "f16[8, 128, 1024]" = torch.ops.aten.view.default(mm_1, [8, 128, 1024]);  mm_1 = None
