...
# kernel path: /scratch/deepseek-prof/cache/vllm/torch_compile_cache/torch_aot_compile/8ac06538b977247782a56a95a6ffbd4521b9b331457fd3260f573cff3f216d59/inductor_cache/rn/crndmicbhsdf5y3l6jnb5akinvzqgz34to66tbbmg4clcno7alff.py
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_2', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': None, 'atomic_add_found': False, 'num_load': 5, 'num_store': 1, 'num_reduction': 4, 'backend_hash': '0F8E6B2A3476BD3493EAF879E6446E2A685A9E4A09C943EF2B03B0DF5D73507F', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'tiling_scores': {'x': 0, 'r0_': 62917632}}
)
@triton.jit
def triton_per_fused_add_native_layer_norm_2(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tl.store(in_out_ptr0 + (r0_1 + 768*x0), tmp35, r0_mask & xmask)
''', device_str='cuda')
...
stream0 = get_raw_stream(0)
buf11 = generate_example_value((8192, 768), (768, 1), 'cuda:0', torch.float16, 0, (8192, 768))
...
with torch.cuda._DeviceGuard(0):
    triton_per_fused_add_native_layer_norm_2.run(buf11, arg4_1, buf7, arg11_1, arg12_1, 8192, 768, stream=stream0)
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [add, add_1, layer_norm_1], Original ATen: [aten.add, aten.native_layer_norm]
            stream0 = get_raw_stream(0)
            triton_per_fused_add_native_layer_norm_2.run(buf11, arg4_1, buf7, arg11_1, arg12_1, s72, 768, stream=stream0)
            del arg11_1
            del arg12_1
            del arg4_1
            del buf7
